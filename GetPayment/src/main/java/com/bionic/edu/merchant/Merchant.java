...
public class Merchant {
  ...
  //getters & setters
	...
	public String getMerchantList() {
		String merchList = "<tr><td>" + this.getName() + "<td>" + this.getBankName() + "<td>" + this.getSwift() + "<td>" + this.getAccount() + "<td>" + this.getCharge() + "<td>" + this.getPeriod() + "<td>" + this.getMinSum() + "<td>" + this.getNeedToSend() + "<td>" + this.getSent() + "<td>" + this.getLastSent() + "</tr>";
		return merchList;
	}
